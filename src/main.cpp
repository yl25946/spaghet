...
int main(int argc, char *argv[])
{
    ...
    if (argc >= 2)
    {
        ...
        if (!strcmp(argv[1], "bench"))
        {
            ...
            std::array<std::string, 50> fens{// fens from stormphrax, which are from alexandria, ultimately from bitgenie
            ...
            std::cout << "info string " << static_cast<int>(time_elapsed / 1000) << " seconds\n"
                      << nodes << " nodes " << 1000 * nodes / time_elapsed << " nps " << std::endl;

            return 0;
        }
    }

    // Board board("8/5k2/8/8/P7/8/8/7K b - - 0 1");
    // std::cout
    //     << NNUE::eval(board);
