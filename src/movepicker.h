...
public:
    ...
    void score(const Board &board, SearchStack *ss, TranspositionTable &transposition_table, QuietHistory &history, CaptureHistory &capthist, ContinuationHistory &conthist, Countermove &countermove, Killers &killers, int threshold);
};