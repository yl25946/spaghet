...
public:
    ...
    inline bool is_clean(const Board &board)
    {
        ...
        return white_king_bucket == king_buckets[WHITE] && black_king_bucket == king_buckets[BLACK] && horizontally_mirrored[WHITE] == should_hm(board, WHITE) && horizontally_mirrored[BLACK] == should_hm(board, BLACK);
    }
