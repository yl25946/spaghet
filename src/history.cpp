...
{
    int white_king_square = lsb(board.pieces[BITBOARD_PIECES::KING] & board.colors[WHITE]);
    int black_king_square = lsb(board.pieces[BITBOARD_PIECES::KING] & board.colors[BLACK]);

    // flip black square because bucket stuff
